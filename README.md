...
This is a fork of [Discord.InteractivityAddon](https://gitlab.com/Playwo/discord.interactivityaddon) that adds several features, including more customization and support for interactions (buttons and select menus).
