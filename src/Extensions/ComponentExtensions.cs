...
public static class ComponentExtensions
{
    ...
    public static ActionRowBuilder AddPaginatorButtons(this ActionRowBuilder builder, IComponentPaginator paginator)
        => builder.AddPreviousButton(paginator)
    ...
    public static ButtonBuilder AsPaginatorButton(this ButtonBuilder builder, IComponentPaginator paginator, PaginatorAction action)
    {
        ...
        string customId = action switch
        {
            PaginatorAction.Backward => ComponentPaginator.PreviousPageId,
            PaginatorAction.Forward => ComponentPaginator.NextPageId,
            PaginatorAction.SkipToStart => ComponentPaginator.FirstPageId,
            PaginatorAction.SkipToEnd => ComponentPaginator.LastPageId,
            PaginatorAction.Exit => ComponentPaginator.StopId,
            PaginatorAction.Jump => ComponentPaginator.JumpId,
            _ => throw new ArgumentOutOfRangeException(nameof(action))
        };

        return builder.WithCustomId(customId)
