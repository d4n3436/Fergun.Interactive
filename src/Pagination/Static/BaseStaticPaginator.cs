...
namespace Fergun.Interactive.Pagination
{
    ...
    public abstract class BaseStaticPaginator : Paginator
    {
            ...
            : base(properties)
        {
            ...
            InteractiveGuards.NotNull(properties.Pages, nameof(properties.Pages));
            InteractiveGuards.NotEmpty(properties.Pages, nameof(properties.Pages));
            InteractiveGuards.IndexInRange(properties.Pages, properties.StartPageIndex, nameof(properties.StartPageIndex));
